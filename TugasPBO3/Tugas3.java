public class Tugas3 {
    public static void main(String[] args) {
        ...
        String[] nama = {"Revan", "Ari", "Justin", "Bieber"};
        ...
        System.out.println("Jumlah Mahasiswa yg lulus : 3 yaitu Revan, Ari, Justin");
        System.out.println("Jumlah Mahasiswa yg Tidak Lulus : 1 yaitu Bieber");
        System.out.println("Jumlah Mahasiswa dengan Nilai A = 2 yaitu Revan, Justin");
